...
export var UIConfigData: { [key: number]: UIConfig } = {
    ...
    [UIID.Login]: { layer: LayerType.UI, prefab: "demo1/login" },
    [UIID.Register]: { layer: LayerType.UI, prefab: "demo1/register" },
    [UIID.Hall]: { layer: LayerType.UI, prefab: "demo1/hall" },
    [UIID.Waiting]: { layer: LayerType.Dialog, prefab: "demo1/waiting" },
    [UIID.Game]: { layer: LayerType.UI, prefab: "demo1/game" },
    [UIID.Header]: { layer: LayerType.UI, prefab: "demo1/header" },
    [UIID.Settlement]: { layer: LayerType.Dialog, prefab: "demo1/settlement" },
}